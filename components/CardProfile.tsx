...
export function CardProfile(props: ProfileCardProps) {
  const {podcastData, imageUrl, userFirstName} = props;
  const {setAudio} = useAudio();
  const [randomPodcast, setRandomPodcast] = React.useState<PodcastProps | null>(
    null,
  );
